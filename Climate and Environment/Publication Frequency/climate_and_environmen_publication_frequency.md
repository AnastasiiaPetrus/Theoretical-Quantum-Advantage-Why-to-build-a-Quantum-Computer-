...
| Algorithm & Method | mentions | fpub |
|------------------------------------------------------|---------|-------|
| Random Forest (RF, DRF, VSURF, QRF, FM-QRF, MIDAS-QRF) | 63      | 0.061 |
| Linear Regression (LR, Least-Squares LR, Multitask LR, Multivar LR, OLS, Multilin R) | 21 | 0.020 |
| Gradient Boosting (GB, XGBoost, LightGBM, CatBoost, GBR) | 19 | 0.018 |
| Convolutional Neural Network (CNN, CNN-BiLSTM-Attention Model, CNN-LSTM, LSTM-CNN, CNN-Transformer, GVSAO-CNN, Mask R-CNN, Multi-Head 1D CNN, 3D CNN) | 17 | 0.016 |
| Long Short-Term Memory (LSTM, GAN-LSTM, Transformer-LSTM, LSTM-AE) | 15 | 0.015 |
| Logistic Regression (LogR, Multilevel LogReg) | 15 | 0.015 |
| Artificial Neural Network (ANN) | 14 | 0.014 |
| Monte Carlo Simulation (MCS, MCMC, MC-Integration) | 12 | 0.012 |
| Support Vector Machine (SVM, SVM with RBF) | 12 | 0.012 |
| Principal Component Analysis (PCA) | 11 | 0.011 |
| Classical Regression Models (GLM, GAM, GAMLSS, LMM, LME, ODE, Quadratic, Quartic) | 9 | 0.009 |
| K-means Clustering (DTW-based K-means Clustering) | 9 | 0.009 |
| K-Nearest Neighbors (KNN, ItemNN, UserNN) | 9 | 0.009 |
| U-Net (Attention U-Net, CentroidNet) | 8 | 0.008 |
| Ensemble Method (Ensemble Averaging, Deep Ensembles, Ensemble Kalman Filter, Stacked Ensemble) | 7 | 0.007 |
| Genetic Algorithm (GA, GA-ANN, NSGA-II, RAGA, GEP) | 7 | 0.007 |
| AutoRegressive Integrated Moving Average/Seasonal Autoregressive Integrated Moving Average (ARIMA/SARIMA, SARIMAX) | 6 | 0.006 |
| Multi-Layer Perceptron (Multi-Layer Perceptron, MLP) | 6 | 0.006 |
| SHAP (Shapley Additive Explanations) | 6 | 0.006 |
| Recurrent Neural Network (RNN, ESN, GRU, Bi-GRU) | 5 | 0.005 |
| Deep / Fully Connected Neural Network (DNN / FNN) | 5 | 0.005 |
| Grid Search Cross-Validation (Grid Search Cross-Validation, Grid Search CV, grid search, GridSearchCV) | 5 | 0.005 |
| Pseudo-Order Kinetics and Adsorption Models (Pseudo-First-Order, Pseudo-Second-Order, Freundlich, Langmuir, GAB) | 5 | 0.005 |
| Ridge Regression (Ridge Regression, Ridge Regression (L2-regularized least squares)) | 5 | 0.005 |
| Support Vector Regression (SVR) | 5 | 0.005 |
| General Circulation Models (MITgcm, HadCM3L, CCSM4, CESM1) | 4 | 0.004 |
| Adam Optimizer (Adam Optimizer, Adam optimizer) | 4 | 0.004 |
| Autoencoder (LSTM-AE, VAE) | 4 | 0.004 |
| Decision Tree (Decision Tree, DT, Decision Tree (DT)) | 4 | 0.004 |
| DeepLabV3+ (DeepLabV3+, DeepLabv3+, DeepLabv3+) | 4 | 0.004 |
| Generative Adversarial Network (GAN, ESRGAN) | 4 | 0.004 |
| Mann–Kendall Trend Test (MK trend test) | 4 | 0.004 |
| Reinforcement Learning (RL, MARL) | 4 | 0.004 |
...
| Differential Flatness Transform (Differential Flatness Transform) | 2 | 0.002 |
...
| Transfer Learning (Transfer Learning, TL) | 2 | 0.002 |
...
| Backward Selection using Akaike Information Criterion (Backward Selection using Akaike Information Criterion) | 1 | 0.001 |
...
| Competitive Technology Intelligence (Competitive Technology Intelligence, CTI) | 1 | 0.001 |
...
| Design–Build–Test–Learn Cycle (Design–Build–Test–Learn Cycle, Design–Build–Test–Learn (DBTL) cycle) | 1 | 0.001 |
...
| Experience Replay (Experience Replay) | 1 | 0.001 |
...
| GEOS (Goddard Earth Observing System) (GEOS (Goddard Earth Observing System)) | 1 | 0.001 |
...
| Langmuir Parameter (Langmuir Parameter, Langmuir parameter) | 1 | 0.001 |
...
| Mean Squared Error Loss (Mean Squared Error Loss, Mean Squared Error (MSE) Loss) | 1 | 0.001 |
...
| Multihead Self-Attention Mechanism (Multihead Self-Attention Mechanism, Multihead Self-Attention Mechanism) | 1 | 0.001 |
...
| Physics-Based Forward Modeling (Physics-Based Forward Modeling, Physics-based forward modelling) | 1 | 0.001 |
...
| Random Node Removal (Random Node Removal, Random node removal) | 1 | 0.001 |
...
| Self-Organizing Map (SOM) | 1 | 0.001 |
...
| Synthetic Carbon Fixation Pathway (Synthetic Carbon Fixation Pathway, Synthetic carbon fixation pathway) | 1 | 0.001 |
...
| Voigt Profile Fitting (Voigt Profile Fitting, Voigt profile fitting) | 1 | 0.001 |
