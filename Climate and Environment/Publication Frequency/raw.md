...
* Convex Combination of Dissimilarity Matrices
...
* Halo-exchange communication via YAXT
...
* Decentralised Training Decentralised Execution (DTDE)
...
* Discrete Element Method (SubZero)
...
Grid-based remote sensing data assimilation
NDVI and land surface temperature indices
...
FLEX hydrological model with Dynamic Identification Analysis (DYNIA)
Spearman rank correlation
ERA5 meteorological reanalysis
Geographic Information System (GIS)-based spatial analysis
Photovoltaic generation model with temperature correction
Ground Coverage Ratio (GCR) model
Optimal tilt angle model based on latitude
Cost adjustment coefficient system
Levelized Cost of Electricity (LCOE) model
Mann-Kendall trend test
Energy substitution simulation model
Homogeneous acid-base catalysis
Heterogeneous acid-base catalysis
Enzymatic catalysis
Immobilized lipase catalysis
...
Membrane separation
Overexpression of metabolic enzymes
Abscisic acid-induced gene regulation
Artificial Neural Networks (ANN)
...
Construction of climate risk indices
AR(1) model
...
sed_eval toolbox
Top-down and downscaling method
...
ISO 12494 analytical model
Messinger model
Moving average filter
Modified ISO 12494 model
Langmuir parameter
Finstad parameterization
Sutherland’s law
Ideal gas law
Monodispersed MVD approximation
...
Heat transfer correlation models
...
Frost number (FN) calculation
Decision tree
Rule-based control logic
Time–rate–distance formula
